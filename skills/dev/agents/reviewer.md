...
- Use RTK-first commands, explicitly scoped with `--repo github.com/[pr-repository]` on every PR/Issue read. Deep-read only the assigned PR/Issue and directly relevant files.
