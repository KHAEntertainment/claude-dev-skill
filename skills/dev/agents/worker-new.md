...
- If plan approval is required, stop after Step 2 and wait for approval before editing files.
...
16. Stop after PR is created, report the PR to the Tech Lead, and wait for Review or shutdown
