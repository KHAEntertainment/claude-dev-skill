...
At any point if a **low-fidelity signal** is detected (see the signal list in `phase1-prototyping.md`), pause the current questioning and dispatch a prototype sub-agent per `phase1-prototyping.md`.
